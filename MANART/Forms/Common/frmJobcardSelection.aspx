...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ReturnChassisValue(objImgControl) {
            ...
            if (objRow[11].childNodes[1].innerText == "N") {
                alert("Insurance Company Customer of jobcard is Inactive. Please make active from Customer Master.");
                return false;
            }            
            if (objRow[8].childNodes[1].innerText == "Y") {
                var r = confirm("To Create Invoice on Insurance Company press Ok");
                if (r == true) {
                    sInvOn = "OnINSC";
                }
                else {
                ...
                if (objRow[8].childNodes[1].innerText == "N" && (objRow[9].childNodes[1].innerText != "0") && objRow[12].childNodes[1].innerText == "N") {
                    sInvOn = "OnINSC";
                }
                else {
                    sInvOn = "OnChaC";
                                ...
                                <asp:Panel ID="PPartDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                    ...
                                    <asp:GridView ID="ChassisGrid" runat="server" AlternatingRowStyle-Wrap="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="CustMsgShow" ItemStyle-Width="10%" ItemStyle-CssClass="HideControl"
                                                HeaderStyle-CssClass="HideControl">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCustShMsg" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("CustMsg") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="InsCustID" ItemStyle-Width="10%" ItemStyle-CssClass="HideControl"
                                                HeaderStyle-CssClass="HideControl">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblInsCustID" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("InsCustID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="CustID" ItemStyle-Width="10%" ItemStyle-CssClass="HideControl"
                                                HeaderStyle-CssClass="HideControl">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCustID" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("CustID") %>'></asp:Label>
                                                </ItemTemplate>
                                                 </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="InsCustActive" ItemStyle-Width="10%" ItemStyle-CssClass="HideControl"
                                                HeaderStyle-CssClass="HideControl">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblInsCustActive" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("InsCustActive") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>  
                                             <asp:TemplateField HeaderText="InsInvDn" ItemStyle-Width="10%" ItemStyle-CssClass="HideControl"
                                                HeaderStyle-CssClass="HideControl">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblInsInvDn" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("InsInvDn") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>                                           
                                        </Columns>
