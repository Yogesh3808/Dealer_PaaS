<%@ Page Language="C#" AutoEventWireup="true" Title="Select Multipart with Invoice" Theme="SkinFile"
    CodeBehind="frmSelMultiPartWithInv.aspx.cs" Inherits="MANART.Forms.Spares.frmSelMultiPartWithInv" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ChkRNPartClick1234(objImgControl) {
            debugger;
                                ...
                                <asp:GridView ID="PartDetailsGrid" runat="server" AlternatingRowStyle-Wrap="true" CssClass="table table-condensed table-bordered"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Discount Amt" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDiscountAmt" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("disc_amt","{0:#0.00}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="HideControl" />
                                            <ItemStyle CssClass="HideControl" Width="1%" />
                                        </asp:TemplateField>
