<%@ Page Title="Receipt for PDI" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmDirectBillingReceiptMTI.aspx.cs" 
    Inherits="MANART.Forms.VehiclePurchase.frmDirectBillingReceiptMTI" MaintainScrollPositionOnPostback="true" %>
            ...
            <td style="width: 14%">
                ...
                <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                                ...
                                <td style="width: 18%">
                                    <uc3:CurrentDate ID="txtMReceiptDate" Mandatory="true" runat="server" bCheckforCurrentDate="false"
                                        />
                                </td>
                                </tr>
                            <tr>
