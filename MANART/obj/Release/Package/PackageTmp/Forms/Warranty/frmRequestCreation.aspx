<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRequestCreation.aspx.cs" Inherits="MANART.Forms.Warranty.frmRequestCreation" %>
...
<head runat="server">
    ...
    <script src="../../Scripts/jquery.datepick.js">
    ...
    <script type="text/javascript">
        function pageLoad() {
            $(document).ready(function () {
                var txtClaimDate = document.getElementById("txtClaimDate_txtDocDate");
                var txtRepairOrderDate = document.getElementById("txtRepairOrderDate_txtDocDate");
                var txtRepairCompleteDate = document.getElementById("txtRepairCompleteDate_txtDocDate");
                var txtFailureDate = document.getElementById("txtFailureDate_txtDocDate");
                var txtInstallationDate = document.getElementById("txtInstallationDate_txtDocDate");
                var txtInvoiceDate = document.getElementById("txtInvoiceDate_txtDocDate");
                var hdnPostShipmentDate = document.getElementById("hdnPostShipmentDate");
                var hdnMinClaimDate = document.getElementById("hdnMinClaimDate");
                var InsDate = '';
                var splInsDate = '';               
                splInsDate = txtInstallationDate.value.split("/")
                InsDate = new Date(splInsDate[2], splInsDate[1], splInsDate[0] - 1);                
                $('#txtInstallationDate_txtDocDate').datepick({
                    onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: (hdnPostShipmentDate.value != '') ? hdnPostShipmentDate.value : '-5y', maxDate: '0d'

                });
                $('#txtInvoiceDate_txtDocDate').datepick({
                ...
                $('#txtClaimDate_txtDocDate').datepick({
                ...
                $('#txtRepairCompleteDate_txtDocDate').datepick({
                ...
                $('#txtRepairOrderDate_txtDocDate').datepick({
                ...
                $('#txtFailureDate_txtDocDate').datepick({
                ...
                function customRange(dates) {
                    if (this.id == 'txtClaimDate_txtDocDate') {
                        $('#txtRepairOrderDate_txtDocDate').datepick('option', 'maxDate', dates[0] || null);
                        $('#txtRepairCompleteDate_txtDocDate').datepick('option', 'maxDate', dates[0] || null);
                        $('#txtFailureDate_txtDocDate').datepick('option', 'maxDate', dates[0] || null);
                    }
                    else if (this.id == 'txtRepairCompleteDate_txtDocDate') {
                        $('#txtClaimDate_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                        $('#txtRepairOrderDate_txtDocDate').datepick('option', 'maxDate', dates[0] || null);
                    }
                    else if (this.id == 'txtRepairOrderDate_txtDocDate') {
                        $('#txtClaimDate_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                        $('#txtRepairCompleteDate_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                        $('#txtFailureDate_txtDocDate').datepick('option', 'maxDate', dates[0] || null);
                    }
                    else if (this.id == 'txtFailureDate_txtDocDate') {
                        $('#txtClaimDate_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                        $('#txtRepairCompleteDate_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                        $('#txtRepairOrderDate_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                    }
                    else if (this.id == 'txtInstallationDate_txtDocDate') {
                        $('#txtInvoiceDate_txtDocDate').datepick('option', 'maxDate', new Date(dates[0].setDate(dates[0].getDate() - 1)) || null);
                        var Orgdates = dates[0];
                        $('#txtFailureDate_txtDocDate').datepick('option', 'minDate', new Date(Orgdates.setDate(Orgdates.getDate() + 1)) || null);

                    }
                    else if (this.id == 'txtInvoiceDate_txtDocDate') {
                        $('#txtInstallationDate_txtDocDate').datepick('option', 'minDate', new Date(dates[0].setDate(dates[0].getDate() + 1)) || null);
                    }
    ...
    <script type="text/javascript">
        ...
        function bCheck() {
            debugger;
            var ObjCombo = window.document.getElementById("DropClaimTypes");
            if (ObjCombo.options[ObjCombo.selectedIndex].value == "2") {
                var ObjOption = window.document.getElementById("OptShareType_0");
                var ObjOption1 = window.document.getElementById("OptShareType_1");
                if (ObjOption.checked == true) {
                    ...
                    if (parseFloat(dVECVShare + dDealerShare + dCustShare) != parseFloat(100)) {
                        alert("Percent value should be equal to 100 !");
                        return false;
                    }
                }
                if (ObjOption1.checked == true) {
                    var ObjGrid = null;
                    var dVECVShare = 0;
                    var dDealerShare = 0;
                    var dCustShare = 0;
                    ...
                    if (ObjGrid != null) {
                        for (i = 1; i < ObjGrid.rows.length; i++) {
                            ...
                            if (parseFloat(dVECVShare + dDealerShare + dCustShare) != parseFloat(100)) {
                                alert("Percent value should be equal to 100 in part detail " + i + " !");
                                return false;
                            }
                        }
                    }
                    ...
                    if (ObjGrid != null) {
                        for (i = 1; i < ObjGrid.rows.length; i++) {
                            ...
                            if (parseFloat(dVECVShare + dDealerShare + dCustShare) != parseFloat(100)) {
                                alert("Percent value should be equal to 100 in labour detail line " + i + " !");
                                return false;
                            }
                        }
                    }
                    ...
                    if (ObjGrid != null) {
                        for (i = 1; i < ObjGrid.rows.length; i++) {
                            ...
                            if (parseFloat(dVECVShare + dDealerShare + dCustShare) != parseFloat(100)) {
                                alert("Percent value should be equal to 100 in lubricant detail " + i + " !");
                                return false;
                            }
                        }
                    }
                    ...
                    if (ObjGrid != null) {
                        for (i = 1; i < ObjGrid.rows.length; i++) {
                            ...
                            dCustShare = dGetValue(ObjGrid.rows[i].cells[9].childNodes[1].value);
                            if (parseFloat(dVECVShare + dDealerShare + dCustShare) != parseFloat(100)) {
                                alert("Percent value should be equal to 100 in sublet detail " + i + " !");
                                return false;
                            }
                        }
                    }
            ...
            //debugger;
            ObjGrid = window.document.getElementById('JobDetailsGrid');

            if (ObjGrid == null) return;
            for (i = 1; i < ObjGrid.rows.length; i++) {
                if (ObjGrid.rows[i].cells[2].childNodes[1].value == "" || ObjGrid.rows[i].cells[2].childNodes[1].value == "0")
                {
                    alert("Please select Causal part for Jobcode Line no " + i + " !");
                    return false;
                }
                if (ObjGrid.rows[i].cells[5].childNodes[1].value == "" || ObjGrid.rows[i].cells[5].childNodes[1].value == "0") {
                    alert("Please select Culprit Code for Jobcode Line no " + i + " !");
                    return false;
                }
                if (ObjGrid.rows[i].cells[6].childNodes[1].value == "" || ObjGrid.rows[i].cells[6].childNodes[1].value == "0") {
                    alert("Please select Defect Code for Jobcode Line no " + i + " !");
                    return false;
                }
                if (ObjGrid.rows[i].cells[2].childNodes[3].value == "N" && (ObjGrid.rows[i].cells[7].childNodes[1].value == "" || ObjGrid.rows[i].cells[7].childNodes[1].value == "0")) {
                    alert("Please select Defect Code for Jobcode Line no " + i + " !");
                    return false;
                }
                //dDealerShare = dGetValue(ObjGrid.rows[i].cells[8].childNodes[1].value);
...
<body runat="server">
    <form id="form1" runat="server" submitdisabledcontrols="true" onclose="return ALter();">
        <asp:CheckBoxList ID="CheckBoxList1" runat="server" AppendDataBoundItems="False"></asp:CheckBoxList>
                    ...
                    <table id="ToolbarContainer" runat="server" width="100%" border="1" class="ToolbarTable">
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-search btn-sm"
                                    Width="100px" OnClick="btnSave_Click" OnClientClick="return bCheck();" />
                            </td>
                            <td>
                                <asp:Button ID="btnConfirm" runat="server" Text="Confirm" CssClass="btn btn-search btn-sm"
                                    Width="100px" OnClick="btnConfirm_Click" />
                            </td>
                            <td>
                                <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-search btn-sm"
                                ...
                                <tr id="RequestDetails">
                                    ...
                                    <td style="width: 18%" colspan="5">
                                        <asp:RadioButtonList ID="OptShareType" runat="server" RepeatDirection="Horizontal">
                                            ...
                                            <asp:ListItem Value="2" onClick=" OnItemWiseSelected(this);">To Item </asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
