...
<%@ Page Title="Direct Billing Order Form" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
     CodeBehind="frmVehOrderFormMTI.aspx.cs" Inherits="MANART.Forms.VehiclePurchase.frmVehOrderFormMTI" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
        ...
        <script type="text/javascript">
            function pageLoad() {
                $(document).ready(function () {
                    ...
                    var txtChqDate = document.getElementById("ContentPlaceHolder1_txtChqDate_txtDocDate");
                    $('#ContentPlaceHolder1_txtChqDate_txtDocDate').datepick({
                        // dateFormat: 'dd/mm/yyyy', minDate: (txtDocDate.value == '') ? '0d' : txtDocDate.value
                        onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: '0d'
                    });


                    var txtCovernoteExpiry = document.getElementById("ContentPlaceHolder1_txtCovernoteExpiry_txtDocDate");
                    $('#ContentPlaceHolder1_txtCovernoteExpiry_txtDocDate').datepick({
                        // dateFormat: 'dd/mm/yyyy', minDate: (txtDocDate.value == '') ? '0d' : txtDocDate.value
                        onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: '0d'
                    });

                    var txtCSTExpiry = document.getElementById("ContentPlaceHolder1_txtCSTExpiry_txtDocDate");
                    $('#ContentPlaceHolder1_txtCSTExpiry_txtDocDate').datepick({
                        // dateFormat: 'dd/mm/yyyy', minDate: (txtDocDate.value == '') ? '0d' : txtDocDate.value
                        onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: '0d'
                    });


                    var txtVATExpiry = document.getElementById("ContentPlaceHolder1_txtVATExpiry_txtDocDate");
                    $('#ContentPlaceHolder1_txtVATExpiry_txtDocDate').datepick({
                        // dateFormat: 'dd/mm/yyyy', minDate: (txtDocDate.value == '') ? '0d' : txtDocDate.value
                        onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: '0d'
                    });
        ...
        <div class="table-responsive">
            ...
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="Order Form"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                  ...
                  <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtRoadPermitDate" Mandatory="false" runat="server" bCheckforCurrentDate="false" />
                                 ...
                                 <td class="auto-style1">
                                  ...
                                  <td>
                                    <asp:TextBox ID="txtSoldToParty" TextMode="MultiLine" 
                                        runat="server" MaxLength="250" CssClass="TextBoxForString" height="50px" OnTextChanged="txtSoldToParty_TextChanged" Text="" ></asp:TextBox>
                            ...
                            <tr>
                                  ...
                                  <td>
                                    <asp:TextBox ID="txtPOAppNo" runat="server" CssClass="TextBoxForString" Visible="false" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                    &nbsp;
                                    </td>
                            </tr>
                         ...
                         <table id="Table3" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                <asp:TextBox ID="txtCSTNo" MaxLength="50" runat="server" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                </td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPAN" MaxLength="50" runat="server" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                </td>
                     ...
                     <asp:Panel ID="Panel4" runat="server" BorderColor="Black" BorderStyle="Double">
                          <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender6" runat="server" TargetControlID="CntDelDet"
                            ExpandControlID="TtlDelDet" CollapseControlID="TtlDelDet" Collapsed="false"
                            ImageControlID="ImgTtlDelDet" ExpandedImage="~/Images/Minus.png" CollapsedImage="~/Images/Plus.png"
                            SuppressPostBack="true" CollapsedText="Delivery Details" ExpandedText="Delivery Details"
                            TextLabelID="lblTtlDelDet">
                        </cc1:CollapsiblePanelExtender>
                         <asp:Panel ID="TtlDelDet" runat="server">
                           <table width="100%">
                                  <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                               
                                        <asp:Label ID="lblTtlDelDet" runat="server" Text="Model" Width="96%"
                                            onmouseover="SetCancelStyleonMouseOver(this);" onmouseout="SetCancelStyleOnMouseOut(this);"></asp:Label>
                                    </td>
                                    <td width="1%">
                                        <asp:Image ID="ImgTtlDelDet" runat="server" ImageUrl="~/Images/Plus.png"
                                            Height="15px" Width="100%" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                         <asp:Panel ID="CntDelDet" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                            ScrollBars="None">
                         ...
                         <tr>
                             ...
                             <td style="width: 15%" class="tdLabel">Delivery Name:
                                  ...
                                  <td class="auto-style1">
                                     ...
                                     <asp:Label ID="lbldeliveryadd" runat="server" Text="Place of Delivery"></asp:Label>
                                    </td>
                                  <td>
 ...
 <tr>
       ...
       <td style="width: 15%" class="tdLabel">Delivery Pincode:
                                        </td>
                                        <td style="width: 18%">
...
<%--                                   <td style="width: 15%" class="tdLabel">Delivery State:
                                        </td>
                                        <td style="width: 18%">
                          ...
                          <td class="auto-style1" id="tdbilllocation" runat="server">
                            ...
                            <tr>
                                ...
                                <td class="auto-style1">
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtCovernoteExpiry" Mandatory="false" runat="server"  bCheckforCurrentDate="false" />
                            ...
                            <tr>
                                   <td class="auto-style1">
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtChqDate" Mandatory="false" runat="server" bCheckforCurrentDate="false" />
            ...
            <tr id="TmpControl">
                <td style="width: 14%">
                    ...
                    <asp:HiddenField ID="hdnHold" runat="server" Value="N" />
                       <asp:HiddenField ID="hidengst" runat="server" Value="" />
                 <asp:HiddenField ID="hdnLost" runat="server" Value="N" />
                     <asp:TextBox ID="txtInqID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                      <asp:TextBox ID="txtCustState" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
               ...
               <table visible="false">
                                ...
                                <tr>
                                <td class="auto-style1" visible="false">
                                   
                                <asp:Label ID="lblConsignee" visible="false" runat="server" Text="Consignee (Ship To) Address:"></asp:Label>
                                </td>
                                <td>
                              ...
                              <%--  <td class="auto-style1" visible="false">
                                ...
                                <td>
                                <uc3:CurrentDate  visible="false" ID="txtCSTExpiry" runat="server" Mandatory="false" bCheckforCurrentDate="false" />
                                ...
                                <td>
                                <uc3:CurrentDate ID="txtVATExpiry" visible="false" runat="server" Mandatory="false" bCheckforCurrentDate="false" />
                                ...
                                <td>
                                <asp:TextBox ID="txtLBT" visible="false" MaxLength="50" runat="server" CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                </td>
                                </tr>
