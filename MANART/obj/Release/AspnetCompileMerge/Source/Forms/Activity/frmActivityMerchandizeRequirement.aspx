<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmActivityMerchandizeRequirement.aspx.cs" Inherits="MANART.Forms.Activity.frmActivityMerchandizeRequirement" %>
    ...
    <table id="PageTbl" class="PageTable table-responsive" border="1">
        <tr id="TitleOfPage" class="panel-heading">
            <td align="center" class="panel-title">
                <asp:Label ID="lblTitle" runat="server" Text="Merchandize Requirement Master"></asp:Label>
            </td>
        </tr>
        <tr id="ToolbarPanel">
            <td>
                        ...
                        <td style="width: 15%; height: 92px;">
                            <asp:Panel ID="PDealerHeaderDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                ...
                                <cc1:CollapsiblePanelExtender ID="CPEDealerHeaderDetails" runat="server" TargetControlID="CntDealerHeaderDetails"
                                    ...
                                    CollapsedImage="~/Images/Plus.png" SuppressPostBack="true" CollapsedText="Activity Merchandize Requirement Header Details"
                                    ExpandedText="Activity Merchandize Requirement Header Details" TextLabelID="lblTtlDealerHeaderDetails">
                                ...
                                <asp:Panel ID="CntDealerHeaderDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                                    <table id="Table1" runat="server" class="table table-bordered">
                                        <tr>
                                            ...
                                            <td style="width: 15%; padding-left: 10px;" class="tdLabel">Merchandize Requirement:
                                            </td>
                                            <td style="width: 15%">
                                              
                                                <asp:TextBox ID="txtMerchandizeRequirement" runat="server" CssClass="TextBoxForString" MaxLength ="50"
                                                    Text=""></asp:TextBox> 
