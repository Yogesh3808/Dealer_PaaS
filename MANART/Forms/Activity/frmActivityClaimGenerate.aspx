<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmActivityClaimGenerate.aspx.cs" Inherits="MANART.Forms.Activity.frmActivityClaimGenerate" %>
        ...
        $(document).ready(function () {
            ...
            function customRange(dates) {
                if (this.id == 'ContentPlaceHolder1_txtDlrActDtFrm_txtDocDate') {
                    $('#ctl00_ContentPlaceHolder1_txtDlrActDtTo_txtDocDate').datepick('option', 'minDate', dates[0] || null);
                }
                else {
      ...
      <table id="PageTbl" class="table-responsive" border="1">
                    ...
                    <asp:Panel ID="CntDocDetails" runat="server" BorderColor="DarkGray" BorderStyle="None"
                        ...
                        <tr>
                            ...
                            <td style="width: 18%">
                                  ...
                                  <asp:DropDownList ID="drpNameOfActivity" runat="server" CssClass="ComboBoxFixedSize" Enabled="false"
                             ...
                             <td style="width: 18%">
                                <asp:TextBox ID="txtTypeOfActivity" runat="server" CssClass="TextBoxForString"  Font-Bold="true" Enabled="false" ></asp:TextBox>
                            </td>
                            ...
                            <Columns>
                              ...
                              <%-- <%-- <asp:TemplateField HeaderText="Expected Exp Head" ItemStyle-Width="10%" ItemStyle-CssClass="HideControl"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <%--<asp:DropDownList ID="drpExpectedExpHead" runat="server" CssClass="GridComboBoxFixedSize" 
                                  ...
                                  <asp:TemplateField HeaderText="Actual Exp Head" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                       <%-- <asp:TextBox ID="txtActualExpHead" CssClass="GridTextBoxForString" runat="server" Width ="96%"
                                         ...
                                         <asp:DropDownList ID="drpActualExpHead" runat="server" CssClass="GridComboBoxFixedSize"
                                                        Width="90%"  >
                                                    </asp:DropDownList>
                                        <%--onblur="return CheckActivityHeadSelected(event,this);"> --%>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Tentative Amount" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtTentativeAmt" CssClass="GridTextBoxForAmount" runat="server" Width ="96%" Enabled ="false" 
                                            Text='<%# Eval("Tentative_Amount","{0:#0.00}") %>' onkeypress="JavaScript:return CheckForNumericForKeyPress(event,0);" ></asp:TextBox>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="Actual Amount" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtActualAmt" CssClass="GridTextBoxForAmount" runat="server" Width ="96%"
                                            Text='<%# Eval("Actual_Amount" ,"{0:#0.00}")%>' onkeypress="JavaScript:return CheckForNumericForKeyPress(event,0);" onblur="return CalculateClaimActualTotal(event,this,'Claim');"></asp:TextBox>
                                    </ItemTemplate>
                                  <FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="Propose MTI % Share" ItemStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtVECVShare" CssClass="GridTextBoxForAmount" runat="server" Text='<%# Eval("VECV_Shr_Per") %>' Width ="96%"
                                            ...
                                            <%--onkeypress="JavaScript:return CheckForNumericForKeyPress(event,0);" onblur="return CalculateClaimLineTotal(event,this,'Request');"></asp:TextBox>--%>
                                    </ItemTemplate>                                    
                                </asp:TemplateField>
        ...
        <tr id="TmpControl">
            ...
            <asp:TextBox
                ...
                <asp:TextBox
                ID="txtstateID" runat="server" Text="" Width="1%"></asp:TextBox>
                ...
                <asp:TextBox ID="txtDealerShare" runat="server" Width="1px" Text="" CssClass="HideControl"></asp:TextBox>
            </td>
        </tr>
    </table>
</asp:Content>
