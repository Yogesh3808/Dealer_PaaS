 <%@ Page Title="Dealer PO" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmVehiclePODealer.aspx.cs" Inherits="MANART.Forms.VehiclePurchase.frmVehiclePODealer" %>
                    ...
                    <asp:Panel ID="Panel3" runat="server" BorderColor="Black" BorderStyle="Double">
                         ...
                         <table id="Table2" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtModelRate" runat="server" onkeypress=" return validateFloatKeyPress(this,event);"
                                            CssClass="TextForAmount"></asp:TextBox>
                                    &nbsp;
                                </td>
            ...
            <tr id="TmpControl">
                <td style="width: 14%">
                 ...
                 <asp:HiddenField ID="hdnLost" runat="server" Value="N" />
                    ...
                    <asp:TextBox ID="txtStandsardDisc" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
