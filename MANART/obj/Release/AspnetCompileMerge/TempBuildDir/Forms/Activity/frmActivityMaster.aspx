<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmActivityMaster.aspx.cs" Inherits="MANART.Forms.Activity.frmActivityMaster" %>
   ...
   <table id="PageTbl" class="table-responsive" border="1">
        <tr id="TitleOfPage" class="panel-heading">
            <td class="PageTitle panel-title" align="center" style="width: 14%">
                <asp:Label ID="lblTitle" runat="server" Text="Activity List Master"></asp:Label>
            </td>
        </tr>
        <tr id="ToolbarPanel">
            <td>
                        ...
                        <td style="width: 15%; height: 92px;">--%>
                            <asp:Panel ID="PDealerHeaderDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                ...
                                <cc1:CollapsiblePanelExtender ID="CPEDealerHeaderDetails" runat="server" TargetControlID="CntDealerHeaderDetails"
                                    ...
                                    CollapsedImage="~/Images/Plus.png" SuppressPostBack="true" CollapsedText="Activity List Details"
                                    ExpandedText="Activity List Details" TextLabelID="lblTtlDealerHeaderDetails">
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr class="panel-heading">
                                            <td align="center" class="ContaintTableHeader panel-title" width="96%">
                                                <asp:Label ID="lblTtlDealerHeaderDetails" runat="server" Text="Activity List Details"
                                ...
                                <asp:Panel ID="CntDealerHeaderDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                                    <table id="Table1" runat="server" class="table table-bordered">
                                        <tr>
                                            <td style="width: 15%; padding-left: 10px;" class="tdLabel">Type of the Activity:
                                            </td>
                                            <td style="width: 15%">
                                                <asp:DropDownList ID="ddlTypeoftheActivity" runat="server"
                                                    CssClass="ComboBoxFixedSize">
                                                </asp:DropDownList>
                                                  
                                                <asp:Label ID="Label3" runat="server" CssClass="Mandatory" Text=" *" Font-Bold="true"></asp:Label>
                                            </td>
                                            <td style="width: 15%; padding-left: 10px;" class="tdLabel">Name of the Activity:
                                            </td>
                                            <td style="width: 15%">
                                              
                                                <asp:TextBox ID="txtNameoftheActivity" runat="server" CssClass="TextBoxForString" MaxLength ="50"
                                                    Text=""></asp:TextBox> 
                                        ...
                                        <tr>
                                     <td style="width: 15%; padding-left: 10px;" class="tdLabel">From Date:
                                            </td>
                            <td>
                                <uc3:CurrentDate ID="txtFromDate" runat="server" bCheckforCurrentDate="false" Mandatory="true"  />
                            </td>
                              <td style="width: 15%; padding-left: 10px;" class="tdLabel">To Date:
                                            </td>
                            ...
                            <td>
                                <uc3:CurrentDate ID="txtToDate"  runat="server" Mandatory="true" bCheckforCurrentDate="false" />
                                        ...
                                        <tr>
                                            <td style="width: 15%; padding-left: 10px">GL Code :</td>
                                            <td style="width: 18%">
                                                <asp:TextBox ID="txtGLCode" runat="server" CssClass="TextBoxForString" MaxLength ="20"
                                                    Text=""></asp:TextBox> 
                                            </td>
                                            <td style="width: 15%; padding-left: 10px">Cost Center :</td>
                                            <td style="width: 18%">
                                                <asp:TextBox ID="txtCostCenter" runat="server" CssClass="TextBoxForString" MaxLength ="20"
                                                    Text=""></asp:TextBox> 
                                            </td>
                                        </tr>
                                        <tr>
