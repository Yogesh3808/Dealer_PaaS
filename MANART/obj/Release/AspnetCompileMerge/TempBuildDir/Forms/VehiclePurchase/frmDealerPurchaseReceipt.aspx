<%@ Page Title="Dealer Purchase" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmDealerPurchaseReceipt.aspx.cs" 
    Inherits="MANART.Forms.VehiclePurchase.frmDealerPurchaseReceipt" %>
    ...
    <table id="PageTbl" class="table-responsive" border="1">
        <tr id="TitleOfPage" class="panel-heading">
            <td class="panel-title" align="center" style="width: 14%">
                <asp:Label ID="lblTitle" runat="server" Text="Dealer Purchase"> </asp:Label>
            </td>
        </tr>
        <tr id="ToolbarPanel">
            <td style="width: 14%">
            ...
            <td style="width: 14%">
                ...
                <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                          ...
                          <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender4" runat="server" TargetControlID="CntDealerPO"
                            ...
                            SuppressPostBack="true" CollapsedText="Dealer Purchase" ExpandedText="Dealer Purchase"
                           ...
                           <table width="100%">
                                  <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                                        ...
                                        <asp:Label ID="lblTtlDealerPO" runat="server" Text="Dealer Purchase" Width="96%"
                            ...
                            <tr>
                                   <td  class="tdLabel">
                                    Supplier:
                                      ...
                                      <td>
                                    <asp:TextBox ID="txtSupplier" runat="server" CssClass="TextBoxForString"  ReadOnly="true" Text=""></asp:TextBox>
                                    </td>
                                    ...
                                    PO Details:
                                      ...
                                      <td>
                                    <asp:TextBox ID="txtPODet" runat="server" ReadOnly="true" CssClass="TextBoxForString" Text=""></asp:TextBox>
                                    </td>
        ...
        <tr id="TmpControl">
            <td style="width: 14%">
                  <asp:TextBox ID="txtControlCount" CssClass="DispalyNon" runat="server" Width="1px"
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                ...
                <asp:TextBox ID="txtTax2ID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                  <asp:TextBox ID="txtPurchDealer" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                 <asp:TextBox ID="txtSAlePOID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                  <asp:TextBox ID="txtchassis_id" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
