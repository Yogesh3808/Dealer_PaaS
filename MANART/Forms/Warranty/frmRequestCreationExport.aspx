<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    Theme="SkinFile" EnableEventValidation="false" CodeBehind="frmRequestCreationExport.aspx.cs" Inherits="MANART.Forms.Warranty.frmRequestCreationExport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Scripts/jsGCRPartfunc.js"></script>        
    <%--<script src="../../Scripts/showModalDialog.js"></script>--%>
    <script src="../../Scripts/jsFileAttach.js"></script>
    <script src="../../Scripts/jsGCRLabourFunc.js"></script>
    <script src="../../Scripts/jsGCRLubricantFunc.js"></script>
    <script src="../../Scripts/jsGCRSubletFunc.js"></script>
    ...
    <script>
        function ShowExportChassisMaster(objNewModelLabel, sDealerId, sHOBR_ID, sUserDepart) {
            debugger;
            ...
            if (DropClaimTypes.selectedIndex == 0) {
                ...
                sClaimTypes = DropClaimTypes.options[DropClaimTypes.selectedIndex].value;
                ChassisDetailsValues = window.showModalDialog("../Common/frmChassisSelection.aspx?DealerID=" + sDealerId + "&HOBR_ID=" + sHOBR_ID + "&JobTypeID=" + sClaimTypes + "&Screen=R", "List", "dialogHeight: 300px; dialogWidth: 800px;  edge: Raised; center: Yes; help: No; scroll: Yes; status: Yes;");
                if (ChassisDetailsValues != null) {
                    ...
                    var hdnChassis = window.document.getElementById('ContentPlaceHolder1_hdnChassis');
                    
                    txtchassisID.value = ChassisDetailsValues[1];
                    hdnChassis.value = ChassisDetailsValues[1];
                }
            }
            return true;
        }
        ...
        function GetSrvVANDtls(objLink, sDealerId) {
            ...
            //debugger;
            var Parameters = "JobID=0&GCRID=" + iJob_HDR_ID + "&ClaimID=0&DealerID=" + sDealerId + "&SrvVANHDRID=" + SrvVANID + "&sWarrTag=Y&sAggregate=N";
    ...
    <script type="text/javascript">
        ...
        function SetPartDetails(objAddNewControl, PartValue) {
            ...
            objRow[3].children[0].value = PartValue[1];


            //SetPartNo
            objRow[4].children[0].value = PartValue[2];
            objRow[4].children[0].style.display = "";
            objRow[4].children[0].readOnly = true;

            //SetPartName
            objRow[5].childNodes[1].value = PartValue[3];
            objRow[5].childNodes[1].style.display = "";
            objRow[5].childNodes[1].readOnly = true;


            // If  Non Warrantable Part
            objRow[3].children[1].value = PartValue[5];
            if (PartValue[5] == "N") {
                objRow[8].children[0].selectedIndex = 0;
                objRow[8].children[0].disabled = false;
            }
            else {
                objRow[8].children[0].selectedIndex = 0;
                objRow[8].children[0].disabled = true;
            }
            objRow[9].children[1].style.display = "";
        ...
        <table id="PageTbl" class="PageTable" border="1">
            <tr id="TitleOfPage" class="panel-heading">
                <td class="panel-title" align="center" style="width: 14%">
                    <p class="HideControl"><span id="arg"></span></p>
                    ...
                    <asp:Panel ID="DocNoDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                        <table id="txtDocNoDetails" runat="server" class="ContainTable">
                            ...
                            <tr>
                                ...
                                <td class="tdLabel" style="width: 15%">Approval No:
                                </td>
                                <td style="width: 18%">
                                    <asp:TextBox ID="txtApprovalNo" runat="server" CssClass="TextBoxForString" Text=""
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td class="tdLabel" style="width: 15%">Approval Date:
                                </td>
                                <td style="width: 18%">
                        ...
                        <asp:Panel ID="CntVehicleDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                            <table id="tblVehicleDetails" runat="server" class="ContainTable">
                                <tr>
                                    <td class="tdLabel" style="width: 15%">
                                        <asp:LinkButton ID="lblSelectModel" runat="server" ForeColor="#49A3D3" onmouseout="SetCancelStyleOnMouseOut(this);"
                                            ...
                                            ToolTip="Select Chassis No " OnClick="lblSelectModel_Click"> </asp:LinkButton>
                                    </td>
                                    <td class="tdLabel" style="width: 15%">
                                    ...
                                    <td class="tdLabel" style="width: 15%">
                                        <asp:Button ID="btnJobConfirm" runat="server" CssClass="btn btn-search btn-sm" Text="Submit Request" Width="145px" OnClick="btnJobConfirm_Click" />
                                    </td>
                                    <td class="tdLabel" style="width: 15%;">
                                ...
                                <tr>
                                    ...
                                    <td class="tdLabel" style="width: 15%">INS Date:
                                    </td>
                                    <td style="width: 18%">
                                        <%--<asp:TextBox ID="txtInstallationDate" Text="" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                    <asp:Label ID="lblMInsDate" runat="server" CssClass="Mandatory" Text=" *" Font-Bold="true"></asp:Label>--%>
                                ...
                                <td style="width: 18%">
                                    MTI Invoice No.:
                                    <asp:TextBox ID="txtInvoiceNo" Text="" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                ...
                                <td style="width: 18%">
                                    <asp:TextBox ID="txtInvoiceDate" Text="" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                    <asp:Label ID="Label7" runat="server" CssClass="Mandatory" Text=" *" Font-Bold="true"></asp:Label>
                                    MTI Invoice Date:
                                     <uc3:CurrentDate ID="txtInvoiceDate" runat="server" Mandatory="true" bCheckforCurrentDate="false"
                                        EnableTheming="True" />
                                </td>
                                <td style="width: 15%" class="tdLabel">
                                ...
                                <tr>
                                    ...
                                    <td class="tdLabel" style="width: 15%"><%--Route Type:--%>
                                    </td>
                                    <td style="width: 18%">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%">
                                        <asp:TextBox ID="txtVehicleNo" Text="" runat="server" CssClass="TextBoxForString"
                                            MaxLength="20"></asp:TextBox><%--<asp:Label ID="lblVehicleNo" runat="server" CssClass="Mandatory"
                                    ...
                                    <td style="width: 18%; display: none">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td style="width: 15%" class="tdLabel">
                                ...
                                <tr id="RequestDetails">
                                    ...
                                    <td style="width: 18%" colspan="5">
                                        <asp:RadioButtonList ID="OptShareType" runat="server" RepeatDirection="Horizontal">
                                            <%--onChange=" OnItemWiseSelected(this);"--%>
                                            <asp:ListItem Value="1" Selected="True" onClick=" OnOverallClaimChangeExport(this);">To Overall Claim</asp:ListItem>
                                            <asp:ListItem Value="2" onClick=" OnItemWiseSelectedExport(this);">To Item </asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr id="RequestDetails1">
                                    <td class="tdLabel" style="width: 15%">
                                        <asp:Label ID="lblVECVShare" runat="server" Text="MTI Share%:"></asp:Label>
                                    </td>
                                    <td style="width: 18%">
                                        <asp:TextBox ID="txtVECVShare" runat="server" CssClass="TextForAmount" Text="" Font-Bold="true"></asp:TextBox>
                                    </td>
                                    <td class="tdLabel" style="width: 15%">
                                        <asp:Label ID="lblDealerShare" runat="server" Text="Dealer Share%:"></asp:Label>
                                    </td>
                                    <td style="width: 18%">
                                ...
                                <asp:Panel ID="CntComplaints" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                    ...
                                    <asp:GridView ID="ComplaintsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="New/Delete" ItemStyle-Width="5%">
                                                <ItemTemplate>
                            ...
                            <asp:Panel ID="PPartDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                ...
                                <asp:Panel ID="CntPartDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                    ...
                                    <asp:GridView ID="PartDetailsGrid" runat="server" AllowPaging="false" AlternatingRowStyle-Wrap="true"
                                        ...
                                        OnRowDataBound="PartDetailsGrid_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="No." ItemStyle-Width="1%">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Failed Part ID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtPartID" runat="server" Text='<%# Eval("Part_No_ID") %>' Width="1%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Job Code" ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="drpJobCode" runat="server" CssClass="GridComboBoxFixedSize" Width="96%">
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="MTI(%)" ItemStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtVECVShare" runat="server" CssClass="GridTextBoxForAmount" Width="96%"></asp:TextBox>
                                                    <%--onkeypress="return CheckPercentageAmount(event,this)" onblur="return CheckPercentageValue(event,this);"--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Dealer(%)" ItemStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDealerShare" runat="server" CssClass="GridTextBoxForAmount" Width="96%"></asp:TextBox>
                                                    <%--onkeypress="return CheckPercentageAmount(event,this)" onblur="return CheckPercentageValue(event,this);"--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cust(%)" ItemStyle-Width="3%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCustShare" runat="server" CssClass="GridTextBoxForAmount" Width="96%"></asp:TextBox>
                                                    <%--onkeypress="return CheckPercentageAmount(event,this)" onblur="return CheckTotalOfPercentage(event,this);"--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="3%" >
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="ChkForDelete" runat="server" onClick="return SelectDeleteCheckboxForPart(this);" />
                                                    <asp:Label ID="lblCancel" runat="server" CssClass="HideControl" ForeColor="#49A3D3" onclick="ClearRowValueForPartWarranty(event,this); "
                                                        onmouseout="SetCancelStyleOnMouseOut(this);" onmouseover="SetCancelStyleonMouseOver(this);"
                                                        Text="Cancel"></asp:Label>
                                                    <asp:LinkButton ID="lnkNew" runat="server" CssClass="HideControl" OnClientClick="return CheckRowValue(event,this);">New</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <asp:Panel ID="PLabourDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                        ...
                        <asp:Panel ID="CntLabourDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                            ...
                            <asp:GridView ID="LabourDetailsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                Width="100%" AllowPaging="false" AlternatingRowStyle-Wrap="true" EditRowStyle-Wrap="true"
                                EditRowStyle-BorderColor="Black" AutoGenerateColumns="False" OnRowCommand="DetailsGrid_RowCommand" OnRowDataBound="LabourDetailsGrid_RowDataBound">
                                <Columns>
                                    <asp:TemplateField HeaderText="No." ItemStyle-Width="1%">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNo" runat="server" CssClass="LabelCenterAlign"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Labour ID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                        HeaderStyle-CssClass="HideControl">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtLabourID" runat="server" Text='<%# Eval("Labour_ID") %>' Width="1"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Labour Description" ItemStyle-Width="30%">
                                        <ItemTemplate>
                                             ...
                                             <asp:DropDownList ID="drpLbrDescription" runat="server" CssClass="GridComboBoxFixedSize"
                                                    Width="98%" onblur="return CheckLbrDescSelected(event,this);">
                                                </asp:DropDownList>
                                                <asp:TextBox ID="txtLbrDescription" runat="server" TextMode="MultiLine" CssClass="TextBoxForString"
                                                    Width="98%" MaxLength="50" onblur="return CheckLbrDescAlreadyUsedInGrid(event,this);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%" ItemStyle-Width="3%">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblCancel" runat="server" CssClass="HideControl" ForeColor="#49A3D3" Text="Cancel" onclick="return ClearRowValueForLabourWarranty(event,this); "
                                                onmouseover="SetCancelStyleonMouseOver(this);" onmouseout="SetCancelStyleOnMouseOut(this);"></asp:Label><asp:LinkButton
                                                    ID="lnkNew" OnClientClick="return CheckRowValue(event,this);" runat="server" CssClass="HideControl">New</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="JobCard Det ID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                        HeaderStyle-CssClass="HideControl">
                                    ...
                                    <asp:GridView ID="LubricantDetailsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Lubricant Type" ItemStyle-Width="18%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkSelectLubricant" runat="server" OnClick="lnkSelectLubricant_Click">Select Lubricant</asp:LinkButton>
                                            ...
                                            <asp:TemplateField HeaderText="Qty" ItemStyle-Width="6%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtQty" runat="server" CssClass="GridTextBoxForAmount" Width="96%"
                                                        onfocus="SetLubricantFocus(this);" onBlur="return CalculateLineTotalForLubricant(event,this);" 
                                            ...
                                            <asp:TemplateField HeaderText="Job Code" ItemStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="drpJobCode" runat="server" CssClass="GridComboBoxFixedSize"
                                                        Width="96%">
                                                    </asp:DropDownList>
                                            ...
                                            <asp:TemplateField HeaderText="MTI(%)" ItemStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtVECVShare" runat="server" CssClass="GridTextBoxForAmount" Width="96%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Dealer(%)" ItemStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDealerShare" runat="server" CssClass="GridTextBoxForAmount" Width="96%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cust(%)" ItemStyle-Width="8%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCustShare" runat="server" CssClass="GridTextBoxForAmount" Width="96%"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="ChkForDelete" runat="server" onClick="return SelectDeleteCheckboxForLubricant(this);" />
                                          ...
                                          <asp:TemplateField HeaderText="Lubricant Location" ItemStyle-Width="15%">
                                            <ItemTemplate>
                            ...
                            <asp:GridView ID="SubletDetailsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                ...
                                <asp:TemplateField HeaderText="Sublet Code" ItemStyle-Width="4%">
                                    ...
                                    <asp:TemplateField HeaderText="Sublet Code" ItemStyle-Width="16%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtLabourID" runat="server" Text="1" Width="1" CssClass="HideControl" ></asp:TextBox>
                                            <asp:TextBox ID="txtLabourCode" Text="9999" runat="server" Width="96%" CssClass="GridTextBoxForString"
                                            onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
            ...
            <tr id="TmpControl">
                <td style="width: 14%">
                    ...
                    <asp:TextBox ID="txtGVW" Text="" runat="server" CssClass="HideControl"></asp:TextBox>
                    ...
                    <asp:HiddenField ID="hdnClaimConfirm" runat="server" /> 
                    <asp:HiddenField ID="hdnTrNo" runat="server" Value="" />
                    <asp:HiddenField ID="HdnSubletLabID" runat="server" Value="" />
                    <asp:HiddenField ID="HdnSubletLabCode" runat="server" Value="" />
                    <asp:HiddenField ID="HdnSubletLabHrs" runat="server" Value="" />
                    <asp:HiddenField ID="HdnSubletLabRate" runat="server" Value="" />
                    <asp:HiddenField ID="hdnCSMSubmit" runat="server" />
                    <asp:HiddenField ID="hdnSrvVANID" runat="server" Value="" />
                    <asp:HiddenField ID="hdnbSrvVAN" runat="server" Value="" />
                </td>
            </tr>
        </table>
    </div>
