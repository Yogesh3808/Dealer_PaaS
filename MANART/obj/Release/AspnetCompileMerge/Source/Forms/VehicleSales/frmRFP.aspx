<%@ Page Title="Request For Price" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmRFP.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmRFP" MaintainScrollPositionOnPostback="true"%>
                  ...
                  <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                             ...
                             <tr>
                                  <td >
                                  <asp:Label ID="Label1" Text="Taxt Details" runat="server"  ></asp:Label>
                                    </td>
                                    <td>
                                    <asp:DropDownList ID="ddltaxdetails" runat="server"  CssClass="TextBoxForString" ></asp:DropDownList>
                                       <asp:Label ID="Label2" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                                    </td>
                                  <td >
                                  <asp:Label ID="lblAppNo" Text="Approval No:" runat="server" Visible="false" ></asp:Label>
                                    </td>
                                    <td>
                                    <asp:TextBox ID="txtPOAppNo" runat="server" Visible="false" CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                    &nbsp;
                                    </td>
                                    <td >
                                  <asp:Label ID="lblAppDate" Text="Approval Date:" runat="server" Visible="false" ></asp:Label>
                                    </td>
                                    <td>
                                    <uc3:CurrentDate ID="txtPOApppDate" Visible="false" runat="server" Mandatory="True" bCheckforCurrentDate="false" />

                                    </td>
                                </tr>
                            <tr>
                                   <td >
                                  <asp:Label ID="lblList" Text="List Price:" runat="server" Visible="false" ></asp:Label>
                                    </td>
                                <td>
                                    <asp:TextBox ID="txtList" Visible="false" runat="server"     onkeypress=" return CheckForTextBoxValue(event,this,'6');" CssClass="TextForAmount"></asp:TextBox>
                                </td>

                                <td >
                                    <asp:Label ID="lblMRP" Text="MRP:" runat="server" Visible="false" ></asp:Label>
                                    </td>
                                <td>
                                    <asp:TextBox ID="txtMRP"  Visible="false" runat="server"     onkeypress=" return CheckForTextBoxValue(event,this,'6');" CssClass="TextForAmount"></asp:TextBox>
                                </td>
                                  
                            </tr>
                            <tr>
                                  <td >
                                  <asp:Label ID="lblHORemarks" Text="HO Remarks:" runat="server" Visible="false" ></asp:Label>
                                    </td>
                                  <td>
                                    <asp:TextBox ID="txtAppRemarks"  Visible="false" runat="server" TextMode="MultiLine"  MaxLength="250" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                    </td>
                            </tr>
