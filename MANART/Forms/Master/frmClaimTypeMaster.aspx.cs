...
{
    public partial class frmClaimTypeMaster : System.Web.UI.Page
    {
        ...
        private void FillSelectionGrid()
        {
            try
            {
                ...
                SearchGrid.AddToSearchCombo("Claim Coad");
                SearchGrid.AddToSearchCombo("Claim Name");
                SearchGrid.iDealerID = iDealerID;
                SearchGrid.iBrHODealerID = iHOBr_id;
                SearchGrid.sGridPanelTitle = "PO Type List";
                SearchGrid.sSqlFor = "M_ClaimType";
                if (iMenuId == 607 || iMenuId == 467)
                {
        ...
        private void DisplayData(DataSet ds)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtClaimName.Text = Func.Convert.sConvertToString(ds.Tables[0].Rows[0]["ClaimCoad"]);
                    txtClaimCoad.Text = Func.Convert.sConvertToString(ds.Tables[0].Rows[0]["Claim_Name"]);
