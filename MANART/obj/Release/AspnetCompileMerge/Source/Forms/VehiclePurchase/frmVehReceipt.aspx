<%@ Page Title="Dealer Vehicle Receipt" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmVehReceipt.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="MANART.Forms.VehiclePurchase.frmVehReceipt" %>
    ...
    <table id="PageTbl" class="table-responsive" border="1">
        <tr id="TitleOfPage" class="panel-heading">
            <td class="panel-title" align="center" style="width: 14%">
                <asp:Label ID="lblTitle" runat="server" Text="Dealer Vehicle Receipt"> </asp:Label>
            </td>
        </tr>
        <tr id="ToolbarPanel">
            <td style="width: 14%">
                    ...
                    <asp:Panel ID="CntDealerPO" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                ...
                                <td style="width: 18%">
                                    <asp:TextBox ID="txtMReceiptNo" Text="" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                </td>
                                <td class="tdLabel">
                    ...
                    <asp:Panel ID="CntTaxDet" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                        ...
                        <table id="Table1" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                ...
                                <td class="tdLabel">Discount
                                </td>

                                <td id="tdvat" runat="server">
                                    <td class="tdLabel">
                                ...
                                <td id="tdcgst" runat="server">
                                 <td class="tdLabel">
                                    ...
                                    <td class="tdLabel">Other Charges
                                    </td>
                                    
                                </td>
                                <td class="tdLabel">TCS
                                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <%-- <asp:TextBox ID="txtCGST" runat="server" ReadOnly="true" CssClass="TextBoxForString"></asp:TextBox>--%>

                                </td></td>
 <td id="tdtaxper" runat="server">
        ...
        <tr id="TmpControl">
                ...
                <asp:TextBox ID="txtCGSTID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                ...
                <asp:TextBox ID="Addtax" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
