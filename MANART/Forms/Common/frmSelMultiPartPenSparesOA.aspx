<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSelMultiPartPenSparesOA.aspx.cs" Inherits="MANART.Forms.Common.frmSelMultiPartPenSparesOA" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function checkAll_OARefALL(objRef) {
            //debugger;
            if (document.getElementById("ddlPenOAList").value == "0" && document.getElementById("DdlSelctionCriteria").value == "OA") {
                alert("*Please Select OA No");
                objRef.checked = false;
                return false;
            }
            if (objRef.checked) {
                document.getElementById("ddlPenOAList").disabled = true;
                document.getElementById("DdlSelctionCriteria").disabled = true;
                //document.getElementById("txtOANO").value = "13351OA17180047";
                document.getElementById("txtOANO").value = document.getElementById("ddlPenOAList").value;
            }
            else {
                document.getElementById("ddlPenOAList").disabled = false;
                document.getElementById("DdlSelctionCriteria").disabled = false;
                //document.getElementById("ddlPenOAList").value = "";
                document.getElementById("ddlPenOAList").value = 0;
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table class="PageTable table-bordered " border="1" width="100%">
                                ...
                                <table style="background-color: #efefef;" width="70%">
                                    <tr align="center">
                                        ...
                                        <td class="tdLabel" style="width: 20%;">
                                            ...
                                            <asp:DropDownList ID="ddlPenOAList" runat="server" CssClass="ComboBoxFixedSize" Style="display: none">
                                            </asp:DropDownList>
                                        </td>

                                        <td class="tdLabel" style="width: 15%;">
                                            <asp:DropDownList ID="DdlSelctionCriteria" runat="server" CssClass="ComboBoxFixedSize"
                                                AutoPostBack="true" OnSelectedIndexChanged="DdlSelctionCriteria_SelectedIndexChanged">
                                                <%--   <asp:ListItem Selected="True" Value="P">Part No</asp:ListItem>
                                                <asp:ListItem Value="N">Part Name</asp:ListItem>--%>
                                                <asp:ListItem Selected="True" Value="P">Part No</asp:ListItem>
                                                <asp:ListItem Value="N">Part Name</asp:ListItem>
                                                <asp:ListItem Value="OA">OA No</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td class="tdLabel" style="width: 15%;">
                                            <asp:CheckBox ID="checkAll_OARef" runat="server" onclick="checkAll_OARefALL(this);" />
                                    ...
                                    <tr>
                                        <td style="padding-left: 20px; color: Red" colspan="4">1.
                                    <a>Zero Stock Parts Not Show in the List</a>                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <asp:Panel ID="PPartDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblPartNoID" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("Part_No_ID") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="OADetID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                            HeaderStyle-CssClass="HideControl">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOADetID" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("OA_Det_ID") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="HideControl" />
                                            <ItemStyle CssClass="HideControl" Width="1%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="OA" ItemStyle-Width="12%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOANo" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("OANo") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="12%" />
                                        </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Total" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblTotal" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("Total","{0:#0.00}") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Part Name" ItemStyle-Width="35%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Group Name" ItemStyle-Width="8%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblGrName" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("Gr_Name") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Part Stock" ItemStyle-Width="7%" ItemStyle-CssClass="LabelRightAlign">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClbal" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("Cl_bal","{0:#0.00}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="LabelRightAlign" Width="7%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Bal OA Qty" ItemStyle-Width="8%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblInvQty" runat="server" CssClass="LabelCenterAlign" Text='<%# Eval("Qty","{0:#0.00}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Discount Per" ItemStyle-Width="1%" HeaderStyle-CssClass="HideControl" ItemStyle-CssClass="HideControl">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Pre GST Stock" ItemStyle-Width="7%">
                                            <ItemTemplate>
                                        ...
                                        <%--Sujata 04092014_End OA Discount and tax taken in Invoice--%>
                                ...
                                <cc2:PagerV2_8 ID="PagerV2_1" runat="server" OnCommand="pager_Command" Width="5000px"
                    ...
                    <tr id="TmpControl">
                        <td style="width: 15%">
                            <asp:TextBox ID="txtPartIds" CssClass="HideControl" runat="server" Width="1px"
                                Text=""></asp:TextBox>
                            <asp:TextBox ID="txtOANO" CssClass="HideControl" runat="server" Width="1px"
                                Text=""></asp:TextBox>
