        ...
        function ShowChassisMaster(objNewModelLabel, sDealerId, sHOBrID) {
            ...
            if (JobID == null) {
                ...
                if (hdnJobHDRID != null) {
                    ...
                    hdnJbInvCustID = document.getElementById("ContentPlaceHolder1_hdnJbInvCustID");
                    if (JobID[12] == "OnINSC") {
                        hdnJbInvCustID.value = JobID[8];
                    }
                    else {
                        hdnJbInvCustID.value = JobID[9];
                    }
                }
            }
            return true;
    ...
    <table id="PageTbl" class="table-responsive" border="1">
        ...
        <tr id="TmpControl">
            <td style="width: 14%">
                ...
                <asp:HiddenField ID="hdnJbInvCustID" runat="server" Value="" />
            </td>
        </tr>
    </table>
</asp:Content>
