...
<%@ Page Title="Direct Billing Order Form Approval" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" 
     CodeBehind="frmVehOrderFormApproval.aspx.cs" Inherits="MANART.Forms.VehiclePurchase.frmVehOrderFormApproval" %>
                ...
                <td style="width: 14%">
                 ...
                 <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                 <td class="auto-style1">
                                    Billing (Sold To) Address:
                                    </td>
                                  <td>
                                    <asp:TextBox ID="txtSoldToParty" TextMode="MultiLine" 
                                        runat="server" MaxLength="100" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                      
                                    </td>
                                 <td class="auto-style1">
                                   
                                       <asp:Label ID="lblConsignee" runat="server" Text="Consignee (Ship To) Address:"></asp:Label>
                                    </td>
                                  <td>
                                    <asp:TextBox ID="txtShipToParty" TextMode="MultiLine" runat="server" 
                             ...
                             <tr>
                                  ...
                                  <td>
                                    <asp:TextBox ID="txtPayerAdd" TextMode="MultiLine" MaxLength="100" runat="server" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                    </td>
                               <td class="auto-style1">
                                   
                                     <asp:Label ID="lbldeliveryadd" runat="server" Text="Delivery Address:"></asp:Label>
                                    </td>
                                  <td>
                                    <asp:TextBox ID="txtDeliveryAdd" TextMode="MultiLine" MaxLength="100" runat="server" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <td class="auto-style1">
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtCSTExpiry" runat="server" Mandatory="false" bCheckforCurrentDate="false" />
                             ...
                             <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtLBT" MaxLength="50" runat="server" CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                </td>
                        ...
                        <table id="Table5" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                  ...
                                  <asp:DropDownList ID="drpTaxtypeother" runat="server" Width="100px" CssClass="ComboBoxFixedSize"
                                    ...
                                    <asp:ListItem Value="2">2% CST</asp:ListItem>
                                      <asp:ListItem Value="3">FULL CST</asp:ListItem>
                                </asp:DropDownList>
                                      </td>
                                   <td class="auto-style1">
                                    Insurance Company:
                            ...
                            <tr>
                                ...
                                <td class="auto-style1">
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtCovernoteExpiry" runat="server" Mandatory="True" bCheckforCurrentDate="false" />
                            ...
                            <tr>
                                   <td class="auto-style1">
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtChqDate" runat="server" Mandatory="True" bCheckforCurrentDate="false" />
                    ...
                    <asp:Panel ID="CntFileAttchDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                        ...
                        <table id="Table4" runat="server" class="ContainTable">
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="FileAttchGrid" runat="server" AllowPaging="false" AlternatingRowStyle-Wrap="true"
                                        ...
                                        GridLines="Horizontal"  HeaderStyle-Wrap="true"
                                        SkinID="NormalGrid" Width="100%">
                                        <Columns>
                                            <asp:TemplateField HeaderText="No." ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNo" runat="server" CssClass="LabelCenterAlign" Text="<%# Container.DataItemIndex + 1  %>"></asp:Label></ItemTemplate>
                                                <ItemStyle Width="1%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ID" ItemStyle-Width="1%" HeaderStyle-CssClass="HideControl"
                                                ItemStyle-CssClass="HideControl">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtFileAttchID" runat="server" Text='<%# Eval("ID") %>' Width="1"></asp:TextBox></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="File Description" ItemStyle-Width="50%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDescription" runat="server" CssClass="GridTextBoxForString" Text='<%# Eval("Description") %>'
                                                        Width="96%"></asp:TextBox></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="File Name" ItemStyle-Width="30%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFile" runat="server" ForeColor="#49A3D3" onmouseout="SetCancelStyleOnMouseOut(this);"
                                                        ...
                                                        Text='<%# Eval("File_Names") %>' ToolTip="Click Here To Open The File" Width="90%"></asp:Label></ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <tr id="TrBtnUpload" runat="server">
