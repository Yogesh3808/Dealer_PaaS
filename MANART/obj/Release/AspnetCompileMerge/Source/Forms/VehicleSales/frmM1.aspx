<%@ Page Title="M1 (Enquiry Generated)" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmM1.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmM1" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Competitor" ItemStyle-Width="10%">
                                    ...
                                    <asp:TemplateField HeaderText="Competitor Make" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtCompetitor" runat="server"
                                                 CssClass="GridTextBoxForString" Width="60%"></asp:TextBox></ItemTemplate><ItemStyle Width="10%" />
                                    </asp:TemplateField>
            ...
            <td style="width: 14%">
             ...
             <asp:HiddenField ID="hdnLost" runat="server" Value="N" />
                 ...
                 <asp:TextBox ID="txtInqID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                  <asp:HiddenField ID="DealerGST" runat="server" Value="" />
