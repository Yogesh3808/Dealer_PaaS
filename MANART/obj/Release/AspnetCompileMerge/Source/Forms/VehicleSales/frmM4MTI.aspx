    ...
    <%@ Page Title="M4 (Financing Process)" Language="C#" MasterPageFile="~/Header.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmM4MTI.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmM4MTI" %>
...
<%@ Register Src="~/WebParts/MTILocation.ascx" TagPrefix="uc2" TagName="Location" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var txtDocDate = document.getElementById("ContentPlaceHolder1_txtM4Date_txtDocDate");
            var DetailsGrid = document.getElementById("<%=DetailsGrid.ClientID%>");
            if (DetailsGrid != null) {
                var Elements = DetailsGrid.getElementsByTagName("input");
            }
        ...
        <script type="text/javascript">
            function pageLoad() {
                $(document).ready(function () {
                    ...
                    //var txtM4Date = document.getElementById("ContentPlaceHolder1_txtM4Date_txtDocDate");
                    //$('#ContentPlaceHolder1_txtM4Date_txtDocDate').datepick({
                    //    // dateFormat: 'dd/mm/yyyy', minDate: (txtDocDate.value == '') ? '0d' : txtDocDate.value
                    //    onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: '0d'
                    //});
        ...
        <div class="table-responsive">
            ...
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="M4 (Financing Process) Details"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                   ...
                   <asp:Panel ID="DocNoDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                    ...
                    <asp:Panel ID="M4DocDet" runat="server" BorderColor="Black" BorderStyle="Double">
                           ...
                           <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender6" runat="server" TargetControlID="M4Det"
                            ExpandControlID="TtlM4Det" CollapseControlID="TtlM4Det" Collapsed="false"
                       ...
                       <table id="Table5" runat="server" class="ContainTable" border="1">
                                ...
                                <td>
                                 ...
                                 <td>
                                    ...
                                    <uc3:CurrentDate ID="txtM4Date" runat="server" Mandatory="true" bCheckforCurrentDate="false" />
                                </td>
                                     <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:ListItem Value="2">N</asp:ListItem>
                                      ...
                                      <asp:Label ID="Label27" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                           ...
                           <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label34" runat="server" Text="100 % Funding:" CssClass="tdLabel"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="drpFullFund" runat="server" Width="100px" CssClass="ComboBoxFixedSize"
                                    EnableViewState="true">
                                    <asp:ListItem Value="0" Selected="True">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Y</asp:ListItem>
                                    <asp:ListItem Value="2">N</asp:ListItem>
                                ...
                                <td>
                                    <asp:TextBox ID="txtLoanAmt" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                     <asp:Label ID="Label28" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                                </td>
