    <%@ Page Title=" M2 (Quotation Submitted)" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmM2MTI.aspx.cs" MaintainScrollPositionOnPostback="true" 
          EnableEventValidation="false" Inherits="MANART.Forms.VehicleSales.frmM2MTI" %>
    ...
    <script type="text/javascript">
        ...
        <script>
            function Finalamoutcalulate() {
                ...
                //$('#ContentPlaceHolder1_QuotationDtls_txtQuotValue_1').blur(function () {
                //    var Disc = Rate - CustDisc;
                //    $('#ContentPlaceHolder1_QuotationDtls_txtQuotValue_2').val(Disc);
                ...
                <td style="width: 14%">
                    <asp:TextBox ID="txtControlCount" CssClass="DispalyNon" runat="server" Width="1px"
                        ...
                        Text=""></asp:TextBox><asp:TextBox ID="txtPreviousDocId" runat="server" CssClass="DispalyNon" Width="1px"
                         ...
                         Text=""></asp:TextBox><asp:TextBox ID="txtHDCode" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
