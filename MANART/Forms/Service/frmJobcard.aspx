                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%" class="">
                                        <%--<asp:Label ID="Label6" runat="server" Text="Estimate Date:"></asp:Label>--%>
                                         <asp:Label ID="Label23" runat="server" Text="Insurnce Company Name:"></asp:Label>
                                    </td>
                                    <td style="width: 18%">
                                        <%--<uc3:CurrentDate ID="dtpEstTm" runat="server" Mandatory="true" bTimeVisible="false" bCheckforCurrentDate="true" />--%>
                                        <asp:DropDownList ID="DrpInsurnceComp" runat="server" CssClass="ComboBoxFixedSize">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <asp:GridView ID="PartDetailsGrid" runat="server" AllowPaging="false" Width="160%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="RMC Rate" ItemStyle-Width="5%" ItemStyle-CssClass="HideControl"
                                         ...
                                         <asp:TemplateField HeaderText="Accidental Dtls" ItemStyle-Width="5%" >
                                            <ItemTemplate>
                                                <asp:DropDownList ID="drpAccdFlag" runat="server" CssClass="GridComboBoxFixedSize"
                                                    Width="96%">
                                                    <asp:ListItem Selected ="True" Text="Non Accidental" Value="N"></asp:ListItem>
                                                    <asp:ListItem Text="Accidental– Approved By Insurance Company" Value="A"></asp:ListItem>
                                                    <asp:ListItem Text="Accidental– Not Approved By Insurance Company" Value="D"></asp:ListItem>
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
