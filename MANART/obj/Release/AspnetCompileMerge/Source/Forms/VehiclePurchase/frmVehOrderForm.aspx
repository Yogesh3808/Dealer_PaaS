...
<%@ Page Title="Direct Billing Order Form" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"
     CodeBehind="frmVehOrderForm.aspx.cs" Inherits="MANART.Forms.VehiclePurchase.frmVehOrderForm" %>
                         ...
                         <table id="Table3" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCSTNo" MaxLength="50" runat="server" ReadOnly="true" CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                </td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPAN" MaxLength="50" runat="server" ReadOnly="true"  CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                </td>
                             ...
                             <tr>
                                  ...
                                  <td>
                                    <asp:TextBox ID="txtDeliveryAdd" TextMode="MultiLine" ReadOnly="true"  height="50px" MaxLength="250" runat="server" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                    </td>
                             </tr>
                        </table>
                    </asp:Panel>
                        ...
                        <table id="Table5" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                   <td class="auto-style1">
                                    ...
                                    <td>
                                    <uc3:CurrentDate ID="txtChqDate" runat="server"  bCheckforCurrentDate="false" />
                                    </td>
                                 <td class="tdLabel">
                                    Payment Amount:
                                </td>
              ...
              <table visible="false">
                  <tr visible="false">
                      <td class="auto-style1" visible="false">
                                       ...
                                       <asp:Label visible="false" ID="lblConsignee" runat="server" Text="Consignee (Ship To) Address:"></asp:Label>
                                    </td>
                                  <td visible="false">
                                    <asp:TextBox visible="false"  ID="txtShipToParty" TextMode="MultiLine" runat="server" 
                   ...
                   <tr visible="false">
                                  ...
                                  <td visible="false">
                                    <asp:TextBox visible="false" ID="txtPayerAdd" TextMode="MultiLine" MaxLength="100" runat="server" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                    </td>
                                ...
                                <tr id="trvatno" runat="server" visible="false">
                                   <td class="auto-style1">
                                    VAT No:
                                </td>

                                <td>
                                    <asp:TextBox ID="txtVATNo"  MaxLength="50" runat="server" CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>
                                </td>
                                    <td visible="false">
                                    Effective Date:
                                    </td>
                                    <td>
                                    <uc3:CurrentDate ID="txtVATExpiry" runat="server" Mandatory="false" bCheckforCurrentDate="false" />
