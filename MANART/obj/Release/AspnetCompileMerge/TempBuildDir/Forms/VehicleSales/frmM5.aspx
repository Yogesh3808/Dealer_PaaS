    ...
    <%@ Page Title="M5 (Agreement & PDC Collected by Financier)" Language="C#" MasterPageFile="~/Header.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmM5.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmM5" %>
...
<asp:Panel ID="M0Details" runat="server" BorderColor="Black" BorderStyle="Double">
                   ...
                   <asp:Panel ID="DocNoDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                                ...
                                <td>
                                    <uc3:CurrentDate ID="txtDocDate" runat="server" Mandatory="false" bCheckforCurrentDate="false" />
