<%@ Page Title="Vehicle Sales Return" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true"  CodeBehind="frmVehSRN.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmVehSRN" %>
        ...
        <div class="table-responsive">
            ...
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="Vehicle Sales Return"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                 ...
                 <%--  <asp:Panel ID="PnlPendingDocument" runat="server" BorderColor="DarkGray" BorderStyle="Double">
                  ...
                  <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                          ...
                          <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender4" runat="server" TargetControlID="CntDealerPO"
                            ...
                            SuppressPostBack="true" CollapsedText="Vehicle Sales Return" ExpandedText="Vehicle Sales Return"
                           ...
                           <table width="100%">
                                  <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                                        ...
                                        <asp:Label ID="lblTtlDealerPO" runat="server" Text="Vehicle Sales Return" Width="96%"
                         ...
                         <table id="Table1" runat="server" class="ContainTable" border="1">
                             ...
                             <tr>
                                  ...
                                  <td  class="tdLabel">
                                   ...
                                   <td  class="tdLabel" id="tddiscountlbl" runat="server" visible="false">
                                    Discount
                                    </td>
                ...
                <td style="width: 14%">
                    ...
                    <asp:HiddenField ID="hdnHold" runat="server" Value="N" />
                     <asp:TextBox ID="txtUserType" CssClass="HideControl" runat="server" Width="1px" Text=""></asp:TextBox>
                      <asp:HiddenField ID="hdvehGST" runat="server" Value="" />
