<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmClaimTypeMaster.aspx.cs" Inherits="MANART.Forms.Master.frmClaimTypeMaster" %>
                            ...
                            <asp:Panel ID="PDealerHeaderDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                ...
                                <asp:Panel ID="CntDealerHeaderDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                                    <table id="Table1" runat="server" class="table table-bordered">
                                        <tr>
                                            <td style="width: 15%; padding-left: 10px">Claim Name :</td>
                                            <td style="width: 18%">
                                                <asp:TextBox ID="txtClaimName" runat="server" CssClass="TextBoxForString" Enabled="false"
                                                    Text=""></asp:TextBox>
                                              
                                            </td>

                                            <td style="width: 15%; padding-left: 10px;" class="tdLabel">Claim Coad :
                                            </td>
                                            <td style="width: 15%">
                                                   <asp:TextBox ID="txtClaimCoad" runat="server" CssClass="TextBoxForString" Enabled="false"
                                                    Text=""></asp:TextBox>
