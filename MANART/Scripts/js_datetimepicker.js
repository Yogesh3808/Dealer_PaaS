...
var CalWidth=200;// calendar width 208
var CellWidth=28;// width of day cell.30
...
function DateFormat(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds)
 {
    NewCssCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds);
 }
...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (Cal.ShowTime) 
	{
		...
		vCalTime+="</td><td align='center' style='font-size:100%; font-weight:bold;'>:</td><td align='center' width='22px'>";
    ...
    {
       vCalTime+="<span id='close_cal' title='close'onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' onmouseover='changeBorder(this, 0)'onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-family: Arial;font-size: 8pt;'>x</span></td>";
    }
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
	   ...
	   var cssStr = ".calTD {font-family: verdana; font-size: 10px; text-align: center; border:0 }\n";
	   //cssStr+= ".calR {font-family: verdana; font-size: 12px; text-align: center; font-weight: bold; color: red;}"
		cssStr+= ".calR {font-family: verdana; font-size: 10px; text-align: center; font-weight: bold;}"
