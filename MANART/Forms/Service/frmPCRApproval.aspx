<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmPCRApproval.aspx.cs"
    Theme="SkinFile" Inherits="MANART.Forms.Service.frmPCRApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type ="text/javascript" >
        ...
        function GetJobcodeDtls(objLink, sDealerId, sJobCodeID, sPCRID, iJob_HDR_ID, sDealerCode) {
            //var iJob_HDR_ID = 0;
            var objRow = objLink.parentNode.parentNode.childNodes;            
            debugger;
            var Parameters = "JobID=" + iJob_HDR_ID + "&DealerID=" + sDealerId + "&JobCodeID=" + sJobCodeID + "&PCRID=" + sPCRID + "&sDealerCode=" + sDealerCode;
                                   ...
                                   <td class="tdLabel" style="width: 15%">
                                    ...
                                    <td style="width: 18%">
                                       <%--<asp:DropDownList ID="drpWarrantyRole" runat="server" CssClass="ComboBoxFixedSize" 
                                        ...
                                        </asp:DropDownList>--%> <%--onselectedindexchanged="drpWarrantyRole_SelectedIndexChanged"  AutoPostBack ="true"  >--%>
                                    </td>
                                </tr>
                                <tr>                                 
                                     <td class="tdLabel" style="width: 15%">
                            ...
                            <table id="Table1" runat="server" class="ContainTable" border="1">
                                <tr>
                                    <td id="Td1" align="center"  style="height: 15px">
                                        Search By PCR No or Jobcard No or Chassis No <asp:TextBox ID="txtSearchText" runat ="server" ></asp:TextBox>
                                        ...
                                        <asp:Panel ID="GridDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                            ...
                                            <asp:GridView ID="WarrantyClaimGrid" GridLines="Horizontal" Width="100%" 
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="ImgSelect" runat="server" ImageUrl="~/Images/arrowRight.png"
                                                                 OnClick="ImgSelect_Click" Style="height: 16px" /> <%--OnClientClick="return ShowWarrantyClaim(this);"--%>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="2%" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="PCR No" ItemStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblClaimNo" runat="server" Text='<%# Eval("PCR_No") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="PCR Date" ItemStyle-Width="8%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblClaimDate" runat="server" Text='<%# Eval("PCR_Date") %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle Width="8%" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Jobcard No" ItemStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblJobcardNo" runat="server" Text='<%# Eval("job_no") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Jobcard Date" ItemStyle-Width="8%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblJobcardDate" runat="server" Text='<%# Eval("JobDate") %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle Width="8%" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="JobID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                                        HeaderStyle-CssClass="HideControl">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblJobcardID" runat="server" Text='<%# Eval("Jobcard_Hdr_ID") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="JobCodeID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                                        HeaderStyle-CssClass="HideControl">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblJobcodeID" runat="server" Text='<%# Eval("JobCodeID") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="DealerID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                                     ...
                                                     <asp:TemplateField HeaderText="HOBrID" ItemStyle-Width="1%" ItemStyle-CssClass="HideControl"
                                                        HeaderStyle-CssClass="HideControl">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblHoBrID" runat="server" Text='<%# Eval("DlrBranchID") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>                                                    
                                                    <%--<asp:TemplateField HeaderText="ClaimTypeID" ItemStyle-Width="1%" ItemStyle-CssClass="HideGridColumn"
                                                        HeaderStyle-CssClass="HideGridColumn">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblClaimTypeID" runat="server" Text='<%# Eval("Claim_Type_ID") %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="HideGridColumn" Width="1%" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="PCR Status" ItemStyle-Width="19%">
                                                        <ItemTemplate>
