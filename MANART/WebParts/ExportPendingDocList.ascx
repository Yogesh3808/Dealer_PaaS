<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExportPendingDocList.ascx.cs" Inherits="MANART.WebParts.ExportPendingDocList" %>
...
<asp:Panel ID="PPendDocList" runat="server" >
    ...
    <asp:Label ID="lblTitle" runat="server" Text="" ForeColor="Red" Font-Bold="true" Font-Size="Small" Font-Names="Verdana" style="display:none">
        ...
        <asp:GridView ID="DocumentGrid" runat="server" CssClass="datatable" CellPadding="0" 
                    ...
                    AlternatingRowStyle-CssClass="odd" RowStyle-CssClass="even" AllowPaging="True" AutoGenerateColumns="false"  OnPageIndexChanging="DocumentGrid_PageIndexChanging" OnRowCommand="DocumentGrid_RowCommand">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImgSelect" runat="server" ImageUrl="~/Images/arrowRight.png" 
                                        onmouseover="SetCancelStyleonMouseOver(this);" onmouseout="SetCancelStyleOnMouseOut(this);" CommandArgument='<%# Eval("ID")+ "," + Eval("Dealer_ID") %>' CommandName="Select" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="PO Type">
                                <ItemTemplate>
                                    <asp:Label ID="lblPoType" runat="server" Text='<%# Eval("PO_Type") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-CssClass="HideControl" HeaderStyle-CssClass="HideControl">
                                <ItemTemplate>
                                    <asp:HiddenField ID="hdnLC" Value="N" runat="server" />
                                    <asp:HiddenField ID="HdnDummyLC" Value="N" runat="server" />
                                    <asp:HiddenField ID="HdnAdvPayment" Value="N" runat="server" />
                                    <asp:HiddenField ID="HdnSAPCreated" Value="N" runat="server" />
