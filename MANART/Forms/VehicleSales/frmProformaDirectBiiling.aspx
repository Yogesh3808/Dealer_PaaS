<%@ Page Title="Proforma Invoice" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmProformaDirectBiiling.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmProformaDirectBiiling" %>
        ...
        <table id="PageTbl" class="PageTable" border="1">
            <tr id="TitleOfPage">
                <td class="auto-style1" align="center">
                    <asp:Label ID="lblTitle" runat="server" Text="Proforma Invoice"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                ...
                <td style="width: 14%">
                    ...
                    <asp:Panel ID="AppDet" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="CntApp"
                            ...
                            SuppressPostBack="true" CollapsedText="Proforma Invoice Details" ExpandedText="Proforma Invoice"
                            ...
                            <table width="100%">
                                <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                                        ...
                                        <asp:Label ID="lblTtlApp" runat="server" Text="Proforma Invoice Details" Width="96%"
                                            onmouseover="SetCancelStyleonMouseOver(this);" onmouseout="SetCancelStyleOnMouseOut(this);"></asp:Label>
                                    </td>
                                    <td width="1%">
                        ...
                        <asp:Panel ID="CntApp" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                            ...
                            <table id="Table1" runat="server" class="ContainTable" border="1">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Proforma No:" CssClass="tdLabel"></asp:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Text="Proforma Date:" CssClass="tdLabel"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                     <td>
                                        <asp:Label ID="Label9" runat="server" Text="Discount Approval No:" CssClass="tdLabel"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDiscAppNo" runat="server" CssClass="TextBoxForString" Text="" onkeydown="return ToSetKeyPressValueFalse(event,this);"></asp:TextBox>

                                    </td>
                                    <td>
                                        <asp:Label ID="Label10" runat="server" Text="Discount Approval Date:" CssClass="tdLabel"></asp:Label>
                                    </td>
                                    <td>
                                        <uc3:CurrentDate ID="txtDiscAppDate" runat="server" Mandatory="True" bCheckforCurrentDate="false" />
                                    </td>
                                ...
                                <tr>
                                      <td>
                                        <asp:Label ID="Label8" runat="server" Text="Final Amount:" CssClass="tdLabel"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtFinalAmt" runat="server"
                                            onkeypress=" return CheckForTextBoxValue(event,this,'6');" CssClass="TextForAmount" Text='<%# Eval("Value","{0:#0}") %>'
                                           ></asp:TextBox>
