<%@ Page Title="Dealer Sale PO" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmDealerPurchasePO.aspx.cs" Inherits="MANART.Forms.VehiclePurchase.frmDealerPurchasePO" %>
        ...
        <div class="table-responsive">
            ...
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="Dealer Sale PO"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                ...
                <td style="width: 14%">
                  ...
                  <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                          ...
                          <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender4" runat="server" TargetControlID="CntDealerPO"
                            ...
                            SuppressPostBack="true" CollapsedText="Dealer Sale PO" ExpandedText="Dealer Sale PO"
                           ...
                           <table width="100%">
                                  <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                                        ...
                                        <asp:Label ID="lblTtlDealerPO" runat="server" Text="Dealer Sale PO" Width="96%"
