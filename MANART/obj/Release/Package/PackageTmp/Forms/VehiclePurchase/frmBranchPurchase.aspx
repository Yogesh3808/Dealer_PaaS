<%@ Page Title="Stock Transfer Receipt" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" CodeBehind="frmBranchPurchase.aspx.cs" 
    Inherits="MANART.Forms.VehiclePurchase.frmBranchPurchase" MaintainScrollPositionOnPostback="true" %>
    ...
    <table id="PageTbl" class="table-responsive" border="1">
        <tr id="TitleOfPage" class="panel-heading">
            <td class="panel-title" align="center" style="width: 14%">
                <asp:Label ID="lblTitle" runat="server" Text="Stock Transfer Receipt"> </asp:Label>
            </td>
        </tr>
        <tr id="ToolbarPanel">
            <td style="width: 14%">
            ...
            <td style="width: 14%">
                ...
                <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                          ...
                          <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender4" runat="server" TargetControlID="CntDealerPO"
                            ...
                            SuppressPostBack="true" CollapsedText="Stock Transfer Receipt" ExpandedText="Stock Transfer Receipt"
                           ...
                           <table width="100%">
                                  <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                                        ...
                                        <asp:Label ID="lblTtlDealerPO" runat="server" Text="Stock Transfer Receipt" Width="96%"
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                ...
                                <td>
                                         ...
                                         <asp:DropDownList ID="drpVehConditon" runat="server"  CssClass="ComboBoxFixedSize">
                                    </asp:DropDownList>
                          ...
                          <tr>
                                 ...
                                 <td>
                                    <asp:Button ID="bChangeToSaleable"  OnClick="ChangeToSaleable" Text="Convert To Saleable" visible="false" runat="server" ></asp:Button>
