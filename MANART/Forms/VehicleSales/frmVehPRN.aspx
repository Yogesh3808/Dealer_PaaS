<%@ Page Title="Vehicle Purchase Return" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmVehPRN.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmVehPRN" %>
        ...
        <table id="PageTbl" class="PageTable" border="1">
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="Vehicle Purchase Return"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                ...
                <td style="width: 14%">
                    ...
                    <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender4" runat="server" TargetControlID="CntDealerPO"
                            ...
                            SuppressPostBack="true" CollapsedText="Vehicle Purchase Return" ExpandedText="Vehicle Purchase Return"
                            ...
                            <table width="100%">
                                <tr class="panel-heading">
                                    <td align="center" class="panel-title" width="96%">
                                        ...
                                        <asp:Label ID="lblTtlDealerPO" runat="server" Text="Vehicle Purchase Return" Width="96%"
                        ...
                        <asp:Panel ID="CntDealerPO" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                            ...
                            <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                                ...
                                <tr>
                                    <td class="tdLabel">Invoice No:
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtReceiptNo" runat="server" CssClass="TextBoxForString" ReadOnly="true"></asp:TextBox>

                                    </td>
                                    <td class="auto-style1">Invoice Date:
                                    </td>
                                    <td>
                                        <uc3:CurrentDate ID="txtReceiptDate" runat="server" Mandatory="false" bCheckforCurrentDate="false" />
                        ...
                        <asp:Panel ID="CntModel" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                            ...
                            <table id="Table2" runat="server" class="ContainTable" border="1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtModelRate" runat="server" CssClass="TextBoxForString" AutoPostBack="true" OnTextChanged="txtModelRate_TextChanged"></asp:TextBox>
                                        &nbsp;
                                    </td>
                        ...
                        <asp:Panel ID="CntTaxDet" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                            ...
                            <table id="Table1" runat="server" class="ContainTable" border="1">
                                ...
                                <tr>
                                    ...
                                    <td class="tdLabel" id="tddiscountlbl" runat="server" visible="false">Discount
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td id="tddiscount" runat="server" visible="false">
                                ...
                                <tr>
                                    ...
                                    <td id="tdtxtdiscount" runat="server" visible="false">
                                        <asp:TextBox ID="txtDisc" runat="server" onkeypress=" return CheckForTextBoxValue(event,this,'6');"
                                            CssClass="TextForAmount" Width="90%" AutoPostBack="true" ReadOnly="true" OnTextChanged="txtDisc_TextChanged"></asp:TextBox>
                                    ...
                                    <td id="tdmount" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtPFCharges" runat="server" AutoPostBack="true" onkeypress=" return CheckForTextBoxValue(event,this,'6');"
                                                CssClass="TextForAmount" Width="90%" ReadOnly="true" OnTextChanged="txtPFCharges_TextChanged"></asp:TextBox>

                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtOthercharges" runat="server" AutoPostBack="true" onkeypress=" return CheckForTextBoxValue(event,this,'6');"
                                                CssClass="TextForAmount" Width="90%" ReadOnly="true" OnTextChanged="txtOthercharges_TextChanged"></asp:TextBox>
            ...
            <tr id="TmpControl">
                <td style="width: 14%">
                    ...
                    <asp:TextBox ID="txtRetailHdr" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtSaleType" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtTypeID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtReceiptHdr" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtSuppID" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
