    ...
    <%@ Page Title="M6 (Delivery Order / Payment to MTI)" Language="C#" MasterPageFile="~/Header.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="frmM6MTI.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmM6MTI" %>
 ...
 <script type="text/javascript">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var txtDocDate = document.getElementById("ContentPlaceHolder1_txtM6Date_txtDocDate");
            var DetailsGrid = document.getElementById("<%=DetailsGrid.ClientID%>");
            if (DetailsGrid != null) {
                var Elements = DetailsGrid.getElementsByTagName("input");
            }
        ...
        <script type="text/javascript">
            function pageLoad() {
                $(document).ready(function () {
                    ...
                    //var txtM6Date = document.getElementById("ContentPlaceHolder1_txtM6Date_txtDocDate");
                    //$('#ContentPlaceHolder1_txtM6Date_txtDocDate').datepick({
                    ...
                    var txtPaymentDate = document.getElementById("ContentPlaceHolder1_txtPaymentDate_txtDocDate");
                    $('#ContentPlaceHolder1_txtPaymentDate_txtDocDate').datepick({
                        // dateFormat: 'dd/mm/yyyy', minDate: (txtDocDate.value == '') ? '0d' : txtDocDate.value
                        onSelect: customRange, dateFormat: 'dd/mm/yyyy', minDate: '0d'
                    });
        ...
        <div class="table-responsive">
            ...
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="M6 (Delivery Order / Payment to MTI)"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
...
<asp:Panel ID="M0Details" runat="server" BorderColor="Black" BorderStyle="Double">
                           ...
                           <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drpModelGroup" runat="server" Visible="false"  CssClass="ComboBoxFixedSize">
                                 ...
                                 <asp:Label ID="Label39" Text="*" Visible="false" runat="server" CssClass="Mandatory"></asp:Label>
                       ...
                       <table id="Table7" runat="server" class="ContainTable" border="1">
                                ...
                                <td>
                                 ...
                                 <td>
                                    ...
                                    <uc3:CurrentDate ID="txtM6Date" runat="server" Mandatory="true" bCheckforCurrentDate="false" />
                                </td>

                                     <td>
                                <asp:Label ID="Label29" runat="server" Text="Likely Buy Date:" CssClass="tdLabel"></asp:Label>
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDoNo" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                      <asp:Label ID="Label30" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                                </td>
                                 <td>
                                ...
                                <td>
                                    <uc3:CurrentDate ID="txtDODate" runat="server" Mandatory="true" bCheckforCurrentDate="false" />
                                </td>
                                <td class="tdLabel">
                                ...
                                <td>
                                    <asp:TextBox ID="txtDoAMt" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                      <asp:Label ID="Label31" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                                </td>
                                ...
                                <td>
                                    <uc3:CurrentDate ID="txtPaymentDate" Mandatory="false" runat="server" bCheckforCurrentDate="false" />

                                </td>
                                </tr>
                           <tr>
                               <td>
                                    <asp:Label ID="Label35" runat="server" Text="Agreement & PDC Collected by Financier:" CssClass="tdLabel"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="drpAggPDCM6" runat="server" Width="100px" CssClass="ComboBoxFixedSize"
                                    EnableViewState="true">
                                    <asp:ListItem Value="0" Selected="True">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Y</asp:ListItem>
                                    <asp:ListItem Value="2">N</asp:ListItem>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPendingRemarksM6" runat="server" CssClass="TextBoxForString"></asp:TextBox>
               ...
               <asp:Panel ID="PFileAttchDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                    ...
                    <asp:Panel ID="CntFileAttchDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                        Style="display: none;">
                        <table id="Table8" runat="server" class="ContainTable">
                            <tr>
                                <td colspan="2">
