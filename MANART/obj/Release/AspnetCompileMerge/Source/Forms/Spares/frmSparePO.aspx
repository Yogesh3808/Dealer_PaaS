<%@ Page Title="Parts PO" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    CodeBehind="frmSparePO.aspx.cs" Inherits="MANART.Forms.Spares.frmSparePO" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 //           debugger;
            ...
            //if (document.getElementById("ContentPlaceHolder1_drpPoType").value == "8" && document.getElementById("ContentPlaceHolder1_DrpEstimate").value == "0") {
            //    errMessage += "*Please Select Estimate.\n";
            //}
            if (errMessage != "") {
                alert(errMessage);
                return false;
        ...
        function ShowMultiPartSearch(objNewPartLabel, sDealerId, bDistSuppl, sSupplierID) {
            ...
            //  PartDetailsValue = window.showModalDialog("frmSelectMultiPartSearch.aspx?DealerID=" + sDealerId + "&IsDistributor=" + bDistSuppl + "&SupplierID=" + sSupplierID + "&SelectedPartID=" + sSelectedPartID + "&SourchFrom=SPOPartDetails&TransFrom=Common", "List", "dialogHeight: 550px; dialogWidth: 700px;");
        ...
        function CalulatePOGranTotal() {
                ...
                //Sujata 19022011
            {
                ...
                if (sPArtName != "" && sStatus != "C" && sStatus != "D") {
                    ...
                    objGrid.rows[i].cells[7].children[0].value = (qty * Rate).toFixed(2);
                    // }
                }
            }
                                    ...
                                    <asp:TemplateField HeaderText="Rate" ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMRPRate" runat="server" CssClass="GridTextBoxForAmount" Width="90%"
                                                Text='<%# Eval("MRPRate","{0:#0.00}") %>' onkeypress=" return CheckForTextBoxValue(event,this,'6');" onblur="return CalculatePOPartTotal(event,this);" Enabled="true"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle Width="7%" />
                                    </asp:TemplateField>
