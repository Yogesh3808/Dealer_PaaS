<%@ Page Title="Request For Price" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmExVehProforma.aspx.cs" Inherits="MANART.Forms.VehiclePurchase.Export.frmExVehProforma" MaintainScrollPositionOnPostback="true"%>
                ...
                <td style="width: 14%">
                  ...
                  <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <asp:Label ID="lblMReceiptNo" runat="server" Text="Proforma Acceptance No"></asp:Label>
                                </td>
                                <td style="width: 18%">
                                    <asp:TextBox ID="txtMReceiptNo" Text="" runat="server" CssClass="TextBoxForString"></asp:TextBox>
                                </td>
                                <td class="tdLabel">
                                    <asp:Label ID="lblMReceiptDate" runat="server" Text="Proforma Acceptance Date"></asp:Label>
                                </td>
                                <td style="width: 18%">
                            ...
                            <tr>
                                <td class="tdLabel">
                                    <asp:Label ID="lblDMSInvNo" runat="server" Text="SAP Proforma"></asp:Label>
                                </td>
                                <td style="width: 18%">
                                ...
                                <td class="tdLabel">
                                    <asp:Label ID="lblInvoiceDate" runat="server" Text="SAP Proforma Date"></asp:Label>
                                </td>
                                <td style="width: 18%">
