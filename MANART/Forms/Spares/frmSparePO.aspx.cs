...
{
    public partial class frmSparePO : System.Web.UI.Page
    {
        int sSupplierId = 0;
        string sFileName = "";
        string PONo = "";
        ...
        private void DisplayData(DataSet ds)
        {
            try
            {
                ...
                if (Func.Convert.sConvertToString(ds.Tables[0].Rows[0]["PO_Confirm"]) == "Y")
                {
                    ...
                    if (Func.Convert.sConvertToString(ds.Tables[0].Rows[0]["PO_Type"]) != "11")
                    {
        ...
        private void SetGridControlProperty()
        {
            try
            {
                ...
                for (int iRowCnt = 0; iRowCnt < PartGrid.Rows.Count; iRowCnt++)
                {
                    ...
                    if (drpPoType.SelectedValue == "11".ToString() && ExportLocation.sSupplierType != "D" && sGroup_Code == "99")
                    {
