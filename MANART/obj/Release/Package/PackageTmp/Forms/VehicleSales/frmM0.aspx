<%@ Page Title="M0 (General Discussion)" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="frmM0.aspx.cs" Inherits="MANART.Forms.VehicleSales.frmM0" MaintainScrollPositionOnPostback="true"%>
    ...
    <script type="text/javascript">
        function pageLoad() {
            $(document).ready(function () {
                ...
                var txtDocDate = document.getElementById("ContentPlaceHolder1_txtDocDate_txtDocDate");
                var txtLastPurchDate = document.getElementById("ContentPlaceHolder1_txtLastPurchDate_txtDocDate");
                $('#ContentPlaceHolder1_txtLastPurchDate_txtDocDate').datepick({
                ...
                <td style="width: 15%; height: 92px;">
                    ...
                    <asp:Panel ID="DocNoDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                      ...
                      <%--              <asp:Label ID="Label2" Text="*" runat="server" CssClass="Mandatory"></asp:Label>--%>
                            ...
                            <tr>
                                <td>
                                         <asp:Label ID="Label18" runat="server" Text="Last Purchase Date:" CssClass=""></asp:Label>
                                </td>
                                <td>
                                        <uc3:CurrentDate ID="txtLastPurchDate" Mandatory="false" runat="server" bCheckforCurrentDate="false" />
                                    </td>

                                <td>
                                         <asp:Label ID="Label19" runat="server" Text="Total No of Fleet:" CssClass=""></asp:Label>
                                </td>
                                <td>
                                     <asp:TextBox ID="txtFleetQty" runat="server"     onkeypress=" return CheckForTextBoxValue(event,this,'5');" CssClass="TextForAmount"></asp:TextBox>
                                <asp:Label ID="Label39" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                                </td>
                                <td>
                                      <asp:Label ID="Label21" runat="server" Text="KAM Customer:" CssClass=""></asp:Label>
                                </td>
                                     <td>
                                <asp:DropDownList ID="drpKAMCust" runat="server" Width="100px" CssClass="ComboBoxFixedSize"
                                    EnableViewState="true">
                                    <asp:ListItem Value="0" Selected="True">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">Y</asp:ListItem>
                                    <asp:ListItem Value="2">N</asp:ListItem>
                                 ...
                                 <tr>
                                <td>
                                    <asp:Label ID="Label2" runat="server" Text="Call Ticket No:" CssClass=""></asp:Label>
                                </td>
                                ...
                                <td style="width: 15%">
                                   ...
                                   <td>
                                    <asp:Label ID="Label17" runat="server" Text="Call Ticket Date:" CssClass=""></asp:Label>
                                </td>
...
<%--</ContentTemplate>
            ...
            <tr id="TmpControl" style="display: none">
                <td style="width: 15%">
                    ...
                    <asp:TextBox ID="txtDoneBy" CssClass="DispalyNon" runat="server"></asp:TextBox>
