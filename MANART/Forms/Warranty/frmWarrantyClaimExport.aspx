<%@ Page Title="" Language="C#" MasterPageFile="~/Header.Master" AutoEventWireup="true"
    Theme="SkinFile" EnableEventValidation="false" CodeBehind="frmWarrantyClaimExport.aspx.cs" Inherits="MANART.Forms.Warranty.frmWarrantyClaimExport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Scripts/jsWCSubletFunc.js"></script>
    ...
    <script>
        function ShowExportChassisMaster(objNewModelLabel, sDealerId, sHOBR_ID, sUserDepart) {
            ...
            if (DropClaimTypes.selectedIndex == 0) {
                ...
                ChassisDetailsValues = window.showModalDialog("../Common/frmChassisSelection.aspx?DealerID=" + sDealerId + "&HOBR_ID=" + sHOBR_ID + "&JobTypeID=" + sClaimTypes + "&ClmInvType=" + sClmInvType + "&Screen=C", "List", "dialogHeight: 300px; dialogWidth: 800px;  edge: Raised; center: Yes; help: No; scroll: Yes; status: Yes;");
                if (ChassisDetailsValues != null) {
                    ...
                    var txtRequestID = document.getElementById("ContentPlaceHolder1_txtRequestID");   

                    txtchassisID.value = ChassisDetailsValues[1];
                    hdnChassis.value = ChassisDetailsValues[1];                    
                    txtRequestID.value = ChassisDetailsValues[17];
                }
            }
            return true;
        }
        ...
        function GetJobcodeDtls(objLink, sDealerId, sJobCodeID, sPCRID, sJobSavedORNot) {
            ...
            var Parameters = "JobID=" + iJob_HDR_ID + "&DealerID=" + sDealerId + "&JobCodeID=" + sJobCodeID + "&PCRID=" + sPCRID + "&Display=N&sFOR=CLM";
        ...
        function GetSrvVANDtls(objLink, sDealerId) {
            ...
            //debugger;
            var Parameters = "JobID=0&GCRID=0&ClaimID=" + iJob_HDR_ID + "&DealerID=" + sDealerId + "&SrvVANHDRID=" + SrvVANID + "&sWarrTag=Y&sAggregate=N";
                        ...
                        <asp:Panel ID="CntVehicleDetails" runat="server" BorderColor="Black" BorderStyle="Double">
                            <table id="tblVehicleDetails" runat="server" class="ContainTable">
                                <tr>
                                    ...
                                    <td class="tdLabel" style="width: 15%;">
                                         <asp:Button ID="btnJobConfirm" runat="server" CssClass="btn btn-search btn-sm" Text="Submit Claim" Width="145px" OnClick="btnJobConfirm_Click" />
                                    </td>
                                ...
                                <asp:Panel ID="CntInvestigations" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                    ...
                                    <asp:GridView ID="InvestigationsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="No." ItemStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label6" runat="server" Text='<%# Container.DataItemIndex + 1  %>' CssClass="LabelCenterAlign"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <asp:Panel ID="PPartDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double"
                                ...
                                <asp:Panel ID="CntPartDetails" runat="server" BorderColor="DarkGray" BorderStyle="Double">
                                    ...
                                    <asp:GridView ID="PartDetailsGrid" runat="server" AllowPaging="false" AlternatingRowStyle-Wrap="true"
                                        ...
                                        SkinID="NormalGrid" Width="100%" OnRowDataBound="PartDetailsGrid_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="No." ItemStyle-Width="1%">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="3%" ><%--ItemStyle-CssClass="HideControl" HeaderStyle-CssClass="HideControl"--%>
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="ChkForDelete" runat="server" Text="" onClick="return SelectDeleteCheckboxForPart(this);" />
                                                    <asp:Label ID="lblCancel" runat="server" ForeColor="#49A3D3" CssClass="HideControl" onclick="ClearRowValueForPartWarranty(event,this); "
                            ...
                            <asp:GridView ID="LabourDetailsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="3%" ItemStyle-Width="3%">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="ChkForDelete" runat="server" onClick="return SelectDeleteCheckboxForLabour(this);" Text="" />
                                    ...
                                    <asp:GridView ID="LubricantDetailsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Qty" ItemStyle-Width="6%">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtQty" runat="server" CssClass="GridTextBoxForAmount" Width="96%"
                                                        onfocus="SetLubricantFocus(this);" 
                                                        onBlur="return CalculateLineTotalForLubricant(event,this);" 
                                                    ...
                                                    <%--onBlur="return CheckLubQtyWithMaxQty(event,this);"--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="ChkForDelete" runat="server" Text="" onClick="return SelectDeleteCheckboxForLubricant(this);" />
                            ...
                            <asp:GridView ID="SubletDetailsGrid" runat="server" GridLines="Horizontal" SkinID="NormalGrid"
                                ...
                                <asp:TemplateField HeaderText="Sublet Code" ItemStyle-Width="4%">
                                    ...
                                    <asp:TemplateField HeaderText="Amount" ItemStyle-Width="5%">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtTotal" runat="server" CssClass="GridTextBoxForAmount" Width="96%" MaxLength="7"
