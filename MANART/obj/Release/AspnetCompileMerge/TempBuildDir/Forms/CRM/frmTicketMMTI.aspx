...
<%@ Page Title="Ticket Management" Language="C#"  MasterPageFile="~/Header.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="frmTicketMMTI.aspx.cs" Inherits="MANART.Forms.CRM.frmTicketMMTI" %>
        ...
        <div class="table-responsive">
            ...
            <tr id="TitleOfPage">
                <td class="PageTitle" align="center" style="width: 14%">
                    <asp:Label ID="lblTitle" runat="server" Text="Ticket Management Approval"> </asp:Label>
                </td>
            </tr>
            <tr id="ToolbarPanel">
                <td style="width: 15%">
                 ...
                 <asp:Panel ID="POHeader" runat="server" BorderColor="Black" BorderStyle="Double">
                        ...
                        <table id="txtDocNoDetails" runat="server" class="ContainTable" border="1">
                           ...
                           <tr>
                               ...
                               <td>
                                   <asp:DropDownList ID="drpTicketType" runat="server" Width="100px" CssClass="ComboBoxFixedSize" EnableViewState="true" >
                               ...
                               <asp:Label ID="Label10" Text="*" runat="server" CssClass="Mandatory"></asp:Label>
                                  ...
                                  <td>
                                    <asp:Label ID="Label12" runat="server" Text="Complaint:" CssClass="tdLabel"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtComplaint" runat="server" Height="50px" TextMode="MultiLine" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtResponseRWH" MaxLength="250" runat="server"  Height="50px"  TextMode="MultiLine" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtResponseRSM"  MaxLength="250" runat="server"  Height="50px"  TextMode="MultiLine" CssClass="TextBoxForString" Text="" ></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtResponseHead" MaxLength="250" runat="server"  Height="50px"  TextMode="MultiLine" CssClass="TextBoxForString" Text="" ></asp:TextBox>
            ...
            <tr id="TmpControl">
                <td style="width: 14%">
                 ...
                 <asp:HiddenField ID="hdnLost" runat="server" Value="N" />
                    ...
                    <asp:TextBox ID="txtAppConfirmRWH" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtAppConfirmLvl2" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtEscavationLvl2" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
                    <asp:TextBox ID="txtEscavationLvl3" runat="server" CssClass="DispalyNon" Width="1px" Text=""></asp:TextBox>
